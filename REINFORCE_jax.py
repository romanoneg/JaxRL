...
def f_loss(model_params, obs, actions, rewards, done):
	...
	returns = discounted_returns(rewards, done)
...
def rollout(rng_input, train_state, env_params, steps_in_episode):
...
train_model(rng, train_state, env_params, EPOCHS=5000, steps_per_episode=500)
